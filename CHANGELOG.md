...
- Add the public Artifact Registry and `geotask inspect schemas --format json` for discovering task-document, execution-result, and control-evaluation schemas and commands.
