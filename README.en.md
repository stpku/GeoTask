...
> **Engineering boundary:** GeoTask Core provides the public state contracts, verification kernel, and Artifact foundation of a verifiable spatiotemporal world model. The verifiable task protocol is the current implementation form. Observation v0.1 carries source-bound claims, World State v0.1 records versioned snapshots, State Transition v0.1 binds before/after states, Verification Session v0.1 freezes audit context, Discrepancy Report v0.1 records bounded differences, Correction Request v0.1 constrains successor-state changes, and Impact Graph v0.1 represents discrepancies, corrections, state paths, assertions, outputs, actions, and reevaluation targets as a validated directed acyclic graph. Automatic diff computation, Observation merging, successor-state materialization, automatic graph discovery and propagation execution, and incremental reevaluation remain under development.
...
The current public Core implements world objects and spatial contracts, source and evidence bindings, Observation v0.1, World State v0.1, State Transition v0.1, Verification Session v0.1, Discrepancy Report v0.1, Correction Request v0.1, Impact Graph v0.1, world claims, deterministic relation verification, control states, mechanical Agent repair, and bounded-path retry. Automatic diff computation, automatic impact-graph discovery and propagation execution, Observation merging, successor-state materialization, and incremental reevaluation remain roadmap capabilities.
