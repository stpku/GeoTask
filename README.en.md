...
- [v0.4.1 Capability Discovery and Release-Hardening maintenance release notes](docs/release_v0_4_1.md)
...
|---|---:|---|
| GeoTask Core package | `0.4.1` | Python implementation version |
