...
- [Try the GT01–GT15 experience](https://stpku.github.io/GeoTask/)
...
- [GT01–GT15 Cookbook](docs/cookbook/gt01-gt15.md)
...
| Action and feasibility | GT10–GT15 | What executable action follows from verified spatial, resource, response, and live-environment constraints? |
...
See the [Cookbook](docs/cookbook/gt01-gt15.md) for all cases and source files.
