...
| 行动与可行性 | GT10—GT16 | 约束确认以后，下一步具体执行什么？ |
...
完整案例、源码和学习路径见[中文案例手册](docs/cookbook/gt01-gt16.zh-CN.md)。
...
- [中文案例手册](docs/cookbook/gt01-gt16.zh-CN.md)
- [英文Cookbook](docs/cookbook/gt01-gt16.md)
