...
- [立即体验GT01—GT31](https://stpku.github.io/GeoTask/)
...
| 验证提供方生态 | GT29—GT31 | 多个外部来源冲突、显式裁决和行动门禁怎样形成独立可信保证？ |
...
GT01—GT20见[基础案例手册](docs/cookbook/gt01-gt20.zh-CN.md)，GT21—GT28见[世界状态循环案例手册](docs/cookbook/gt21-gt28.zh-CN.md)，GT29—GT31见[验证提供方接口规范](docs/spec/geotask-verification-provider-profile-v0.1.zh-CN.md)。
