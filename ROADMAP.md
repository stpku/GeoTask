...
- provide a public-safe external HTTP JSON transport Adapter example outside Core, with offline Descriptor binding, strict Response loading, and transport/operation failure separation;
