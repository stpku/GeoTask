...
- [GeoTask Trajectory and Moving Object Profile v0.1](spec/geotask-trajectory-profile-v0.1.md) — identity/position separation, strictly ordered timezone-aware samples, adjacent-segment distance and average speed, and the GT33–GT34 non-prediction/non-execution boundary.
