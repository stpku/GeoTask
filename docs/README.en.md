...
- [GeoTask Artifact Registry v1.0](spec/geotask-artifact-registry-v1.0.md) — `geotask inspect schemas` discovery for all eleven public Artifacts, their schemas, versions, and operating commands.
- [GeoTask Artifact Validation v1.0](spec/geotask-artifact-validation-v1.0.md) — one `geotask artifact validate` entry point for validating all eleven registered public Artifacts, including Agent reports, Runtime messages, and validation reports themselves, by stable Artifact ID.
...
- [GeoTask Runtime Interface Profile v0.1](spec/geotask-runtime-interface-profile-v0.1.md) — Descriptor, Request, Response, authorization, idempotency, audit, and side-effect boundaries between Core and an external Runtime, plus public-safe HTTP JSON Adapter and loopback reference Endpoint examples.
