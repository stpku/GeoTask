...
- [GeoTask Artifact Registry v1.0](spec/geotask-artifact-registry-v1.0.md) — `geotask inspect schemas` discovery for all twenty-eight public Artifacts and twenty-nine public JSON Schemas.
...
- [GeoTask Trajectory and Moving Object Profile v0.1](spec/geotask-trajectory-profile-v0.1.md) — identity/position separation, strictly ordered timezone-aware samples, adjacent-segment metrics, caller-declared classifications, identity candidates, and the GT33–GT38 non-prediction/non-execution boundary.
...
- [GeoTask Artifact Validation v1.0](spec/geotask-artifact-validation-v1.0.md) — one `geotask artifact validate` entry point for validating all twenty-eight registered public Artifacts, including trajectory identity adjudication, world-state, Agent, Runtime, Verification Provider, benchmark, and validation-report contracts.
