...
- [GT01–GT14 Cookbook](cookbook/gt01-gt14.md) — progressive examples from distance calculation to evidence governance and object-specific feasibility.
...
- [中文快速入门](tutorials/quickstart.zh-CN.md) and [中文案例手册](cookbook/gt01-gt14.zh-CN.md).
