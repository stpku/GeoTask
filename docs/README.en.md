...
- [GT01–GT18 Cookbook](cookbook/gt01-gt18.md) — progressive examples from distance calculation to evidence governance, object-specific feasibility, emergency dispatch, city-event deduplication, and equipment capability.
...
- [中文快速入门](tutorials/quickstart.zh-CN.md) and [中文案例手册](cookbook/gt01-gt18.zh-CN.md).
