...
- [Verification Quality Benchmark v0.2](reference/verification-quality-benchmark-v0.2.md) — expands coverage to 34 deterministic synthetic perturbations across threshold, freshness, conflict, consistent multi-source, human-control, correction/impact, replay, and side-effect boundaries; it is not real-world accuracy, cross-domain generalization, or Core Promotion evidence.
...
- [v0.4.1 Capability Discovery and Release-Hardening maintenance release notes](release_v0_4_1.md)
