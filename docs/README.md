...
GeoTask文档按照“理解项目、开始使用、查阅规范、扩展开发”四类组织。第一次接触GeoTask，建议先阅读白皮书和中文快速入门，再结合GT01—GT18案例理解完整工作方式。
...
- [GT01—GT18中文案例手册](cookbook/gt01-gt18.zh-CN.md)：从距离计算逐步进入证据治理、对象相关可行性、应急调度、城市事件去重和设备能力约束。
...
- [英文Quickstart](tutorials/quickstart.md)与[英文Cookbook](cookbook/gt01-gt18.md)。
