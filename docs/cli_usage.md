...
- `inspect schemas` lists all thirty-one public Artifacts, covering the GeoTask
  ...
  verifies the Registry Schema and all thirty-one Artifact Schemas; with an
...
- `schema verify` checks the versioned Bundle Manifest, expected filenames,
  ...
  With no Artifact ID it checks all thirty-two bundled Schemas; supplying one
