...
The registry currently contains exactly thirty artifacts:
...
16. GeoTask Execution Result v1.0;
17. GeoTask Control Evaluation Result v1.0;
18. GeoTask Agent Generation Preparation Report v0.1;
19. GeoTask Agent Revision Verification Report v0.1;
20. GeoTask Agent Revision Retry Report v0.1;
21. GeoTask Agent Evidence Recovery Report v0.1;
22. GeoTask Runtime Descriptor v0.1;
23. GeoTask Runtime Request v0.1;
24. GeoTask Runtime Response v0.1;
25. GeoTask Verification Provider Descriptor v0.1;
26. GeoTask Verification Request v0.1;
27. GeoTask Verification Response v0.1;
28. GeoTask Assurance Profile v0.1;
29. GeoTask Core Benchmark Report v0.1;
30. GeoTask Artifact Validation Report v1.0.
...
checks the Registry Schema plus all thirty registered Artifact Schemas; exact
...
The wheel and source distribution include all thirty-one public JSON Schemas needed to
interpret the Registry and its thirty registered Artifacts. Callers can load them
...
The complete payload contains all thirty descriptors in stable display order.
