...
The registry currently contains exactly twenty-seven artifacts:
...
22. GeoTask Verification Provider Descriptor v0.1;
23. GeoTask Verification Request v0.1;
24. GeoTask Verification Response v0.1;
25. GeoTask Assurance Profile v0.1;
26. GeoTask Core Benchmark Report v0.1;
27. GeoTask Artifact Validation Report v1.0.
...
checks the Registry Schema plus all twenty-seven registered Artifact Schemas; exact
...
The wheel and source distribution include all twenty-eight public JSON Schemas needed to
interpret the Registry and its twenty-seven registered Artifacts. Callers can load them
...
The complete payload contains all twenty-seven descriptors in stable display order.
...
- stable artifact IDs for the twenty-seven current entries;
