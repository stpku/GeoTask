...
当前公共 Core 已实现世界对象和空间合同、来源与证据绑定、Observation v0.1、World State v0.1、State Transition v0.1、Verification Session v0.1、Discrepancy Report v0.1、世界命题、本地确定性验证、控制状态、Agent机械修复、限定路径重试和证据恢复。自动差异计算、Observation合并、Correction Request、状态物化、影响图执行和增量重算仍是后续工程目标。
