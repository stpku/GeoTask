...
if [[ ! -f "$SOURCE/gt15/index.html" ]]; then
  echo "Missing GT15 page: $SOURCE/gt15/index.html" >&2
  exit 1
fi

if [[ ! -f "$SOURCE/gt16/index.html" ]]; then
  echo "Missing GT16 page: $SOURCE/gt16/index.html" >&2
  exit 1
fi

if [[ ! -f "$SOURCE/gt17/index.html" ]]; then
  echo "Missing GT17 page: $SOURCE/gt17/index.html" >&2
  exit 1
fi

if [[ ! -f "$SOURCE/gt18/index.html" ]]; then
  echo "Missing GT18 page: $SOURCE/gt18/index.html" >&2
  exit 1
fi

if [[ ! -f "$SOURCE/gt19/index.html" ]]; then
  echo "Missing GT19 page: $SOURCE/gt19/index.html" >&2
  exit 1
fi

if [[ ! -f "$SOURCE/gt20/index.html" ]]; then
  echo "Missing GT20 page: $SOURCE/gt20/index.html" >&2
  exit 1
fi
...
test -f "$TARGET/gt15/index.html"
test -f "$TARGET/gt16/index.html"
test -f "$TARGET/gt17/index.html"
test -f "$TARGET/gt18/index.html"
test -f "$TARGET/gt19/index.html"
test -f "$TARGET/gt20/index.html"
...
echo "  GT15: $TARGET/gt15/index.html"
echo "  GT16: $TARGET/gt16/index.html"
echo "  GT17: $TARGET/gt17/index.html"
echo "  GT18: $TARGET/gt18/index.html"
echo "  GT19: $TARGET/gt19/index.html"
echo "  GT20: $TARGET/gt20/index.html"
echo
...
echo "  https://skyswind.tailf4fad8.ts.net/geotask/gt15/"
echo "  https://skyswind.tailf4fad8.ts.net/geotask/gt16/"
echo "  https://skyswind.tailf4fad8.ts.net/geotask/gt17/"
echo "  https://skyswind.tailf4fad8.ts.net/geotask/gt18/"
echo "  https://skyswind.tailf4fad8.ts.net/geotask/gt19/"
echo "  https://skyswind.tailf4fad8.ts.net/geotask/gt20/"
