...
COOKBOOK_EN = ROOT / "docs" / "cookbook" / "gt01-gt17.md"
COOKBOOK_ZH = ROOT / "docs" / "cookbook" / "gt01-gt17.zh-CN.md"
...
def test_document_indexes_link_primary_layers_and_localized_guides() -> None:
    ...
    expected_links = (
        ...
        "cookbook/gt01-gt17.md",
        "cookbook/gt01-gt17.zh-CN.md",
        "release_v0_1_0.md",
        "../ROADMAP.md",
...
def test_public_manifest_requires_localized_and_community_entrypoints() -> None:
    ...
    expected = {
        ...
        "docs/cookbook/gt01-gt17.zh-CN.md",
